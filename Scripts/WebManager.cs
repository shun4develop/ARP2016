...
public class WebManager : MonoBehaviour {
	...
	public void contentsUpload(Action<string> positive_func,Action negative_func,RegisterContents item){
		...
		WWW www = new WWW (CONTENTS_UPLOAD);

		throwQueryToServer (www,positive_func,negative_func);
	}
	public void contentsUpload(Action<string> positive_func,RegisterContents item){
		contentsUpload (positive_func,EMPTY_FUNCTION,item);
	}
	...
	public void getSNSIcon(Action<Texture2D> success_func,string url){
		getSNSIcon (success_func,EMPTY_FUNCTION,url);
	}
	...
	public void getResources(Action<Texture2D> success_func,string filepath){
		getResources (success_func,EMPTY_FUNCTION,filepath);
	}
	...
	public void findUserName(Action<string> find_func,string user_name){
		findUserName (find_func,EMPTY_FUNCTION,user_name);
	}
	...
	public void autoLogin(Action<string> positive_func){
		autoLogin (positive_func,EMPTY_FUNCTION);
	}
